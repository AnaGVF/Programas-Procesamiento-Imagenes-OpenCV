# 3. Construye una matriz de 10x8 con números aleatorios entre 1 y 50 y 
#    guarda en un arreglo el número y la posición de los valores que se encuentran arriba de 30.
